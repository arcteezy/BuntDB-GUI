...
/* harmony import */ var _components_data_content_data_content_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/data-content/data-content.component */ "./src/app/components/data-content/data-content.component.ts");
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [
                ...
                _components_data_content_data_content_component__WEBPACK_IMPORTED_MODULE_6__["DataContentComponent"]
            ],
            imports: [
...
/***/ "./src/app/components/data-content/data-content.component.css":
/*!********************************************************************!*\
  !*** ./src/app/components/data-content/data-content.component.css ***!
  \********************************************************************/
/*! no static exports found */
...
/***/ "./src/app/components/data-content/data-content.component.html":
/*!*********************************************************************!*\
  !*** ./src/app/components/data-content/data-content.component.html ***!
  \*********************************************************************/
/*! no static exports found */
...
/***/ "./src/app/components/data-content/data-content.component.ts":
/*!*******************************************************************!*\
  !*** ./src/app/components/data-content/data-content.component.ts ***!
  \*******************************************************************/
/*! exports provided: DataContentComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DataContentComponent", function() { return DataContentComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
var DataContentComponent = /** @class */ (function () {
    function DataContentComponent(dataService) {
    ...
    // Add data function
    DataContentComponent.prototype.addData = function () {
        ...
        if (this.newData.key == '') {
            ...
            this.dataService.writeData(this.newData).subscribe(function (response) {
    ...
    DataContentComponent.prototype.getAllData = function () {
        var _this = this;
        this.dataService.getAllData().subscribe(function (response) {
            console.log("Get all data response : ", response);
            if (response != null) {
                _this.dataContent = JSON.parse(response.body);
            }
        }, function (error) {
            console.log("Error : ", error.error);
        });
    ...
    DataContentComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __webpack_require__(/*! ./data-content.component.html */ "./src/app/components/data-content/data-content.component.html"),
            styles: [__webpack_require__(/*! ./data-content.component.css */ "./src/app/components/data-content/data-content.component.css")]
        }),
...
var DataService = /** @class */ (function () {
    ...
    // Write data
    DataService.prototype.writeData = function (data) {
        return this.http.post(this.serverURL + '/writeData', data, httpOptions);
    };
...
module.exports = __webpack_require__(/*! D:\College\Angular\bunt-gui\src\main.ts */"./src/main.ts");
